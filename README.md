...
[![Docker](https://img.shields.io/badge/Docker%20Hub-iamdmitrij/speedtest-blue.svg?logo=docker)](https://hub.docker.com/r/iamdmitrij/speedtest/)
...
```bash
docker run --rm iamdmitrij/speedtest:latest
```
